...
namespace AppSenAgriculture.Views.Account
{
    ...
    public partial class frmFacilitateur : Form
    {
        ...
        private void AfficherMessageMotDePasse(string motDePasse, string nomFacilitateur, string identifiant)
        {
            string message = $"✅ Facilitateur ajouté avec succès!\n\n" +
                           $"👤 Nom: {nomFacilitateur}\n" +
                           $"🔑 Identifiant: {identifiant}\n" +
                           $"🔒 Mot de passe temporaire: {motDePasse}\n\n" +
                           $"⚠️  Veuillez noter ce mot de passe!\n" +
                           $"Le facilitateur devra le changer lors de la première connexion.";

            DialogResult result = MessageBox.Show(
                message + "\n\n" + "📋 Voulez-vous copier le mot de passe dans le presse-papiers?",
                "Succès - Facilitateur Créé",
